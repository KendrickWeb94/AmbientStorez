            ...
            <div className="flex cursor-pointer items-center gap-6">
              ...
              {!user ? (
                ...
                <div className="relative flex items-center gap-5">
                  ...
                  />
                  {showDropdown && (
                    <div className="absolute translate-y-8 p-2 right-0 mt-12 w-36 bg-white border-gray-400/45 border rounded-lg shadow-lg z-10">
                      <ul className=" flex-col-reverse flex">
                        <li
                          onClick={handleSignOut}
                          className="p-2 cursor-pointer text-sm flex items-center gap-3 rounded hover:bg-gray-200"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                        ...
                        <hr></hr>
                        <li className="p-2 flex rounded items-center gap-3 cursor-pointer hover:bg-gray-200">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
